...
const toggleHtml = `
                  <div className="space-y-2 pt-2">
                    ...
                    <button
                      ...
                      className="w-full bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl py-3 px-4 text-sm text-white transition flex items-center justify-between"
                    >
